...
into
	Card
	(name, rank, maxHealth, targetClass, multiusable, power, defence, initiative, description, price) 
values
	("warrior", 1, 10, "11000", true, 8, 2, 15, "mighty warrior", 80),
	("archer", 1, 7, "11000", true, 5, 1, 25, "fast archer", 80),
	("mage", 1, 5, "11000", true, 12, 0, 20, "intelligent mage", 80),
	("heal", 1, 1, "01110", false, -5, 0, 50, "restore health of player or card", 30),
	("shot", 1, 1, "10000", false, 4, 0, 50, "cause direct damage to player or card", 30),
	("wall", 1, 15, "01000", false, 0, 2, 0, "defence structure", 40),
	("tower", 1, 10, "01000", false, 4, 2, 50, "defence structure, deal damage to attacking card", 50);
