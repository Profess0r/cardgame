...
public class BattleMessageDecoder implements Decoder.Text<BattleMessage> {

    @Override
    public BattleMessage decode(String msg) throws DecodeException {
        BattleMessage message = null;
        ...
        if (willDecode(msg)) {
            try {
                ...
                message = mapper.readValue(msg, BattleMessage.class);
